...
export const metadata: Metadata = {
  title: isHosted
    ...
    : "Samaritan — OpenClaw GUI Dashboard for Local AI Agents",
  description: isHosted
    ? "Chat with and manage your AI agent from one dashboard in AgentBay."
    : "Samaritan is the open-source OpenClaw GUI and AI agent dashboard. " +
  ...
  applicationName: isHosted ? "AgentBay" : "Samaritan",
  ...
  openGraph: {
    type: "website",
    siteName: isHosted ? "AgentBay" : "Samaritan — OpenClaw GUI",
    title: isHosted
      ? "Your AI Agent — AgentBay"
      : "Samaritan — The AI Agent Dashboard for OpenClaw",
    description: isHosted
      ? "Chat with and manage your AI agent from one dashboard in AgentBay."
  ...
  twitter: {
    ...
    title: isHosted
      ? "Your AI Agent — AgentBay"
      : "Samaritan — OpenClaw GUI & AI Agent Dashboard",
    description: isHosted
      ? "Chat with and manage your AI agent from one dashboard in AgentBay."
