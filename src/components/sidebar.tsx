        ...
        <div className={cn("shrink-0", collapsed ? "px-2 pb-2" : "px-3 pb-3 pt-3")}>
          {collapsed ? (
            <div className="flex flex-col items-center gap-2">
              <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-white shadow-sm ring-1 ring-stone-200 dark:bg-[#171a1d] dark:ring-[#2c343d] overflow-hidden">
                <img src="/logo.png" alt="Samaritan" className="h-7 w-7 object-contain" />
              </div>
            </div>
          ) : (
