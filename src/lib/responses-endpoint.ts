/**
 * Auto-enable the OpenResponses endpoint on the gateway for streaming chat.
 *
 * Extracted from api/gateway/route.ts so it can be imported by other routes
 * without violating Next.js's restriction on non-HTTP exports in route files.
 */
